...
const _C_member_initializers_5b44eo = [];

class C {
  constructor() {
    _C_member_initializers_5b44eo.forEach(initialize => initialize.call(this));
  }
  m(v) {
    return v * 2;
  }
...
C.prototype.m = decorator(C.prototype.m, {
  ...
  addInitializer: initializer => _C_member_initializers_5b44eo.push(initializer)
}) ?? C.prototype.m;
