...
const _C_class_initializers_23qh6 = [];
...
C = logged(C, {
  ...
  addInitializer: initializer => _C_class_initializers_23qh6.push(initializer)
}) ?? C;

_C_class_initializers_23qh6.forEach(initializer => initializer.call(C, C));
