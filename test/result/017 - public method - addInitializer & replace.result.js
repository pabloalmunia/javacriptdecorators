...
const _C_member_initializers_qufd2o = [];

class C {
  constructor() {
    _C_member_initializers_qufd2o.forEach(initialize => initialize.call(this));
  }
  m(v) {
    return v * 2;
  }
...
C.prototype.m = decorator(C.prototype.m, {
  ...
  addInitializer: initializer => _C_member_initializers_qufd2o.push(initializer)
}) ?? C.prototype.m;
