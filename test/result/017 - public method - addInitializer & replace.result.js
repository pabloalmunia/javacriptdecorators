...
const _C_member_initializers_k8nh1 = [];

class C {
  constructor() {
    _C_member_initializers_k8nh1.forEach(initialize => initialize.call(this));
  }
  m(v) {
    return v * 2;
  }
...
C.prototype.m = decorator(C.prototype.m, {
  ...
  addInitializer: initializer => _C_member_initializers_k8nh1.push(initializer)
}) ?? C.prototype.m;
