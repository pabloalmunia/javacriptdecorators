...
const _C_member_initializers_u9nmm = [];

class C {
  constructor() {
    _C_member_initializers_u9nmm.forEach(initialize => initialize.call(this));
  }
  m(v) {
    return v * 2;
  }
...
C.prototype.m = decorator(C.prototype.m, {
  ...
  addInitializer: initializer => _C_member_initializers_u9nmm.push(initializer)
}) ?? C.prototype.m;
