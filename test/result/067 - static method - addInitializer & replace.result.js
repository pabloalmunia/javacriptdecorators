...
const _C_static_initializers_qpa3sg = [];
...
C.m = decorator(C.m, {
  ...
  addInitializer: initializer => _C_static_initializers_qpa3sg.push(initializer)
}) ?? C.m;

_C_static_initializers_qpa3sg.forEach(initializer => initializer.call(C, C));
