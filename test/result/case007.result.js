...
const _C_class_initializers_7rg3oo = [];
...
C = logged(C, {
  ...
  addInitializer: initializer => _C_class_initializers_7rg3oo.push(initializer)
}) ?? C;

_C_class_initializers_7rg3oo.forEach(initializer => initializer.call(C, C));
