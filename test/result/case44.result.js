...
let _initializer_202tkpmamgo;
let _initializer_psdghqqku8g;

class C {
  p = _initializer_psdghqqku8g(_initializer_202tkpmamgo(10));
}

_initializer_psdghqqku8g = decorator2(undefined, {
  kind: "field",
  name: "p",
  isStatic: false,
  isPrivate: false,
...
_initializer_202tkpmamgo = decorator1(undefined, {
  kind: "field",
  name: "p",
  isStatic: false,
  isPrivate: false,
