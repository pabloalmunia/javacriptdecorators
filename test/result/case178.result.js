...
const _C_G_descriptor_3vllp = Object.getOwnPropertyDescriptor(C, G);

_C_G_descriptor_3vllp.set = double(_C_G_descriptor_3vllp.set, {
  kind: "setter",
  name: G,
  isStatic: true,
  isPrivate: false,
  defineMetadata: __DefineMetadata(C, G)
}) ?? _C_G_descriptor_3vllp.set;

Object.defineProperty(C, G, _C_G_descriptor_3vllp);
